package com.gardener.unit_testing.ui.noteslist;
...
import com.gardener.unit_testing.R;
...
import com.gardener.unit_testing.util.VerticalSpacingItemDecorator;
...
public class NotesListsActivity extends DaggerAppCompatActivity implements
            ...
            new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT | ItemTouchHelper.LEFT) {
                ...
                public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
                    ...
                    try {
                        ...
                        deleteAction.observe(NotesListsActivity.this, new Observer<Resource<Integer>>() {
                            @Override
